...
export const resolveModel = (
  ...
  models: Array<Model> | undefined = runtimeState.models?.data,
): Model | undefined => {
...
export const resolveUpstreamModelId = (
  requestedModelId: string,
  models: Array<Model> | undefined = runtimeState.models?.data,
): string =>
  resolveModel(requestedModelId, models)?.id ?? stripSnapshotSuffix(requestedModelId)
